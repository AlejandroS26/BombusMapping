...
```{r}
#SubGenera_data <- utils::read.csv('data/DataSeparation_emu.csv', #stringsAsFactors = FALSE, na = c(' ','','NA'))
#SubGen_data <- subset(SubGenera_data, !is.na(DarLongitude) & #!is.na(X.DarLatitude))
#summary(SubGen_data)
```
